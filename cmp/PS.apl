PS←{
	...
	_←p[i]{ti←p[⍺] ⋄ ki←ti,⍺,⍵
		...
		nt≡'VVV'      :n[ti]←n[1⊃⍵]⊣k[ki]←2  4  1 ¯1  1
		nt≡'V←V'      :n[ti]←n[2⊃⍵]⊣k[ki]←1  9  1 ¯1 ¯1
		...
		nt≡'V(VVV)V'  :n[ti]←n[3⊃⍵]⊣k[ki]←4 58  1 ¯1  2 ¯1  2 ¯1  1
		nt≡'V←V(VVV)V':n[ti]←n[5⊃⍵]⊣k[ki]←4 67  1 ¯1  1 ¯1  2 ¯1  2 ¯1  1
