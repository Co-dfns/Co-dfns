GC←{
	...
	pref,←⊂'int lftid_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int left_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *lft;'
	...
	pref,←⊂'int recip_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int divide_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *cd_div;'
	pref,←⊂'int exponent_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int power_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *cd_exp;'
	pref,←⊂'int natlog_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int logarithm_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *cd_log;'
	pref,←⊂'int absolute_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int residue_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *res;'
	pref,←⊂'int floor_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int minimum_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *min;'
	pref,←⊂'int ceiling_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int maximum_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *max;'
	pref,←⊂'int notscl_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int without_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *not;'
	pref,←⊂'int materialize_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int sqd_idx_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *sqd;'
	pref,←⊂'int factorial_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int binomial_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	...
	pref,←⊂'int greatereql_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	...
	pref,←⊂'int logand_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *and;'
	pref,←⊂'int lognan_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *cd_nan;'
	pref,←⊂'int lognor_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *nor;'
	pref,←⊂'int pitimes_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'int trig_f(struct cell *, struct cell **, struct cell *, struct cell *, struct cell ***);'
	pref,←⊂'DECLSPEC struct cell *cir;'
	...
	pref,←⊂'DECLSPEC struct cell *oup;'
	pref,←⊂'DECLSPEC struct cell *jot;'
	pref,←⊂''
	...
	zz[i],←{
		...
		z ←check_vars fi yi
		z,←(n[⍵]<0)⍴⊂'tmp = ',tgt,';'
		z,←((t[yi]=V)∧n[yi]<0)⍴⊂'ref_cell(',y,');'
		z,←(lx[fi]=¯4)⍴⊂'CHK(',fn,'_f(NULL, &',tgt,', NULL, ',y,', NULL), cleanup, ',dbg,');'
		z,←(lx[fi]≠¯4)⍴⊂'CHK((',fn,'->f.fn[0])(',fn,', &',tgt,', NULL, ',y,', env), cleanup, ',dbg,');'
		z,←(n[⍵]<0)⍴⊂'free_cell(tmp); tmp = NULL;'
		z,←((lx[fi]=¯7)∧n[fi]>0)⍴⊂'free_cell(',fn,'); ',fn,' = NULL;'
		z,←((n[yi]>0)∨(t[yi]=V)∧n[yi]<0)⍴⊂'free_cell(',y,');'
		z,←(n[yi]>0)⍴⊂y,' = NULL;'
		z,⊂''
	}¨i
	...
	zz[i],←{
		...
		z,←(n[⍵]<0)⌿⊂'tmp = ',tgt,';'
		z,←((t[xi]=V)∧n[xi]<0)⍴⊂'ref_cell(',x,');'
		z,←((t[yi]=V)∧n[yi]<0)⍴⊂'ref_cell(',y,');'
		z,←(lx[fi]=¯4)⍴⊂'CHK(',fn,'_f(NULL, &',tgt,', ',x,', ',y,', NULL), cleanup, ',dbg,');'
		z,←(lx[fi]≠¯4)⍴⊂'CHK((',fn,'->f.fn[1])(',fn,', &',tgt,', ',x,', ',y,', env), cleanup, ',dbg,');'
		z,←(n[⍵]<0)⌿⊂'free_cell(tmp); tmp = NULL;'
		z,←((n[xi]>0)∨(t[xi]=V)∧n[xi]<0)⌿⊂'free_cell(',x,');'
		z,←(n[xi]>0)⍴⊂x,' = NULL;'
		z,←((lx[fi]=¯7)∧n[fi]>0)⌿⊂'free_cell(',fn,'); ',fn,' = NULL;'
		z,←((n[yi]>0)∨(t[yi]=V)∧n[yi]<0)⌿⊂'free_cell(',y,');'
		z,←(n[yi]>0)⍴⊂y,' = NULL;'
	...
	zz[i],←{
		0=≢i:0⍴⊂''
		tgt←⊃var_values ⍵ ⋄ dbg←highlight ⍵
		bxv x fn y←var_values⊢bi xi fi yi←⍵⊃kk
		z ←check_vars xi fi yi
		z,←⊂tgt,' = ref_cell(',y,');'
		z,←(lx[fi]=¯4)⍴⊂'CHK(',fn,'_f(NULL, &',bxv,', ',x,', ',tgt,', NULL), cleanup, ',dbg,');'
		z,←(lx[fi]≠¯4)⍴⊂'CHK((',fn,'->f.fn[1])(',fn,', ',bxv,', ',x,', ',tgt,', env), cleanup, ',dbg,');'
