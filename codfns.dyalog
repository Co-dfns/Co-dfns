...
_←⍬
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\VC\Auxiliary\Build\vcvarsall.bat'
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio\2019\Professional\VC\Auxiliary\Build\vcvarsall.bat'
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvarsall.bat'
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\VC\Auxiliary\Build\vcvarsall.bat'
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio\2017\Professional\VC\Auxiliary\Build\vcvarsall.bat'
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat'
_,←,⊂'\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat'
_,←,⊂'\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvarsall.bat'
VS∆PS←_
...
_,←'   [&](VEC<A>&v){err(16,L"Image requires a flat array.");},',(⎕ucs 10),'   [&](carr&v){w->image(unrav(v,a.s).T().as(rnk(a)==2?f32:u8));}},',(⎕ucs 10),'  a.v);}',(⎕ucs 10)
...
_,←'   [&](carr&v){w->plot(unrav(v,a.s).T().as(f32));}},',(⎕ucs 10),'  a.v);}',(⎕ucs 10),'EXPORT V w_hist(lp*d,D l,D h,Window*w){A a;cpda(a,d);',(⎕ucs 10),' std::visit(visitor{',(⎕ucs 10)
_,←'   [&](NIL&_){err(6);},',(⎕ucs 10),'   [&](VEC<A>&v){err(16,L"Hist requires a flat array.");},',(⎕ucs 10),'   [&](carr&v){w->hist(unrav(v,a.s).T().as(u32),l,h);}},',(⎕ucs 10),'  a.v);}',(⎕ucs 10)
...
_,←,⊂('OD(jot,"jot",(scm(l)&&scm(r)),(scd(l)&&scd(r)),MFD,DFD,MT ,MT )',(⎕ucs 10),'MF(jot_o){if(!fl){rr(z,aa,r,e);R;}if(!fr){ll(z,r,ww,e);R;}',(⎕ucs 10),' rr(z,r,e);',(⎕ucs 10),' ll(z,z,e);',(⎕ucs 10 32 125 10),'DF(jot_o){if(!fl||!fr){err(2);}',(⎕ucs 10),' A t;',(⎕ucs 10),' rr(t,r,e);',(⎕ucs 10),' ll(z,l,t,e);',(⎕ucs 10 125 10 10))
