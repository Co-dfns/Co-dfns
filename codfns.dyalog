...
rtn[39],←⊂'MF(red_o){A x=r;if(!rnk(r))cat_c(x,r,e);',NL
...
rtn[40],←⊂'MF(rdf_o){B rr=rnk(r);if(rr>4)err(16);',NL
...
rtn[48],←⊂'DF(dot_o){I lr=(I)rnk(l),rrk=(I)rnk(r);if(lr>4||rrk>4)err(16);',NL
