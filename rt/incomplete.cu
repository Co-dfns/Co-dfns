...
I codfns_indexgenm(A*z,A*l,A*r,A**ig){g2h(r);typ(z)=2;I64*c=(I64*)elm(r);
 scale(z,1,*c);shp(z)[0]=*c;I64*d=(I64*)elm(z);DO(*c,d[i]=i);ong(z)=0;R 0;}
I codfns_squadd(A*z,A*l,A*r,A**ig){g2h(r);g2h(l);scale(z,1,shp(r)[1]);
 ...
 ong(z)=0;R 0;}
I codfns_indexd(A*z,A*l,A*r,A**ig){g2h(l);g2h(r);I64*le=(I64*)elm(l);
 typ(z)=typ(r);
 if(typ(z)==3){D*ze,*re=(D*)elm(r);prep((V**)&ze,z,l);DO(siz(z),ze[i]=re[le[i]]);}
 else{I64*ze,*re=(I64*)elm(r);prep((V**)&ze,z,l);DO(siz(z),ze[i]=re[le[i]]);};
 ong(z)=0;R 0;}
I codfns_reshapem(A*z,A*l,A*r,A**ig){g2h(r);scale(z,1,rnk(r));
 typ(z)=2;*shp(z)=rnk(r);I64*e=(I64*)elm(z);DO(rnk(r),e[i]=shp(r)[i]);
 ong(z)=0;R 0;}
I codfns_reshaped(A*z,A*l,A*r,A**ig){g2h(l);g2h(r);
 ...
 ong(z)=0;R 0;}
I codfns_catenated(A*z,A*l,A*r,A**ig){g2h(l);g2h(r);
 ...
 ong(z)=0;R 0;}
I codfns_ptredd(A*z,A*l,A*r,A**ig){g2h(l);g2h(r);
