...
struct codfns_array t1 = {
	0, 1, apl_type_d, 0, NULL, d1, NULL
};

struct codfns_array t2 = {
	0, 1, apl_type_d, 0, NULL, d2, NULL
};

struct codfns_array t3 = {
	1, 5, apl_type_d, 0, s1, d3, NULL
};

struct codfns_array t4 = {
	1, 2, apl_type_i, 0, s2, d4, NULL
};

struct codfns_array t5 = {
	1, 2, apl_type_i, 0, s3, d5, NULL
};

struct codfns_array t6 = {
	0, 1, apl_type_i, 0, NULL, d6, NULL
};

struct codfns_array t7 = {
	0, 1, apl_type_i, 0, NULL, d7, NULL
};
