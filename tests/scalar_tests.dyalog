...
S←('IL' 'FL' 'BL')∘.{⍺,' ',⍵}('IR' 'FR' 'BR')
⍎¨(∘.,⍨'ifb'){'scalar∆',N,'∆',⍺,'_TEST←''scl∆',FN,'''#.util.MK∆T2 ',⍵}¨S
Z←0 0⍴⍬
∇

∇Z←N SCL∆TST∆RELATIVE(FN IL IR FL FR BL BR);L;R
S←('IL' 'FL' 'BL')∘.{⍺,' ',⍵}('IR' 'FR' 'BR')
⍎¨(∘.,⍨'ifb'){'scalar∆',N,'∆',⍺,'_TEST←''scl∆',FN,''' 1e¯7 #.util.MK∆T3 ',⍵}¨S
Z←0 0⍴⍬
∇

∇Z←N SCL∆TST∆MONADIC(FN I F B)
⍎¨'ifb'{'scalar∆',N,'∆',⍺,'_TEST←''scl∆',FN,'''#.util.MK∆T1 ',⍵}¨'IFB'
Z←0 0⍴⍬
∇
...
scalar∆bs_TEST←'scl∆Run' 1e¯10#.util.MK∆T3 L R
