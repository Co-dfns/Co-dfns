...
∆redfirst∆39_TEST←'redfirst∆max' MK∆T1 (?2048⍴0)
∆redfirst∆40_TEST←'redfirst∆and' MK∆T1 (?128⍴2)
∆redfirst∆41_TEST←'redfirst∆and' MK∆T1 (?2048⍴2)
∆redfirst∆42_TEST←'redfirst∆lor' MK∆T1 (?128⍴2)
∆redfirst∆43_TEST←'redfirst∆lor' MK∆T1 (?2048⍴2)
∆redfirst∆44_TEST←'redfirst∆xor' MK∆T1 (?128⍴2)
∆redfirst∆45_TEST←'redfirst∆xor' MK∆T1 (?2048⍴2)
∆redfirst∆46_TEST←'redfirst∆R1'  MK∆T1 (?16 16⍴2)
∆redfirst∆47_TEST←'redfirst∆R1'  MK∆T1 (?1024 1024⍴2)
∆redfirst∆48_TEST←'redfirst∆R1'  MK∆T1 (?16 16⍴0)
∆redfirst∆49_TEST←'redfirst∆R1'  MK∆T1 (?1024 1024⍴0)
∆redfirst∆50_TEST←'redfirst∆R2'  MK∆T1 (?16 16⍴2)
∆redfirst∆51_TEST←'redfirst∆R2'  MK∆T1 (?1024 1024⍴2)
∆redfirst∆52_TEST←'redfirst∆R2'  MK∆T1 (?16 16⍴0)
∆redfirst∆53_TEST←'redfirst∆R2'  MK∆T1 (?1024 1024⍴0)
∆redfirst∆50_TEST←'redfirst∆min' MK∆T1 (?16 16⍴2)
∆redfirst∆51_TEST←'redfirst∆min' MK∆T1 (?1024 1024⍴2)
∆redfirst∆52_TEST←'redfirst∆min' MK∆T1 (?16 16⍴0)
∆redfirst∆53_TEST←'redfirst∆min' MK∆T1 (?1024 1024⍴0)
∆redfirst∆50_TEST←'redfirst∆max' MK∆T1 (?16 16⍴2)
∆redfirst∆51_TEST←'redfirst∆max' MK∆T1 (?1024 1024⍴2)
∆redfirst∆52_TEST←'redfirst∆max' MK∆T1 (?16 16⍴0)
∆redfirst∆53_TEST←'redfirst∆max' MK∆T1 (?1024 1024⍴0)
∆redfirst∆54_TEST←'redfirst∆and' MK∆T1 (?16 16⍴2)
∆redfirst∆55_TEST←'redfirst∆and' MK∆T1 (?1024 1024⍴2)
∆redfirst∆56_TEST←'redfirst∆lor' MK∆T1 (?16 16⍴2)
∆redfirst∆57_TEST←'redfirst∆lor' MK∆T1 (?1024 1024⍴2)
∆redfirst∆56_TEST←'redfirst∆xor' MK∆T1 (?16 16⍴2)
∆redfirst∆57_TEST←'redfirst∆xor' MK∆T1 (?1024 1024⍴2)
