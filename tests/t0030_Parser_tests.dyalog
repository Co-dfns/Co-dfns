...
inp←NS⊂'5'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 11 11)(27 12 12)
out←ast(⍬ ⍬)(sym_base,5)
∆0003_TEST←out PARSE∆SUCC inp

inp←NS⊂'123'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 11 11)(29 14 14)
out←ast(⍬ ⍬)(sym_base,123)
∆0004_TEST←out PARSE∆SUCC inp

inp←NS⊂'.5'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 11 11)(28 13 13)
out←ast(⍬ ⍬)(sym_base,.5)
∆0005_TEST←out PARSE∆SUCC inp

inp←NS⊂'05.123'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 11 11)(32 17 17)
...
inp←NS⊂'¯05.123'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 11 11)(33 18 18)
out←ast(⍬ ⍬)(sym_base,¯5.123)
∆0008_TEST←out PARSE∆SUCC inp

inp←NS⊂'¯05.'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 11 11)(30 15 15)
out←ast(⍬ ⍬)(sym_base,¯5)
∆0009_TEST←out PARSE∆SUCC inp

inp←NS⊂'(¯05.)'
ast←(0 1 2)(3 0 7)(0 0 0)(0 0 ¯5)(0 12 12)(32 16 16)
out←ast(⍬ ⍬)(sym_base,¯5)
∆0010_TEST←out PARSE∆SUCC inp

inp←NS⊂'⍬'
ast←(0 1)(3 0)(0 0)(0 0)(0 11)(27 12)
out←ast(⍬ ⍬)(sym_base)
