...
int ptr2410(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2411(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr2412(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2413(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2414(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr2415(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2416(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr2417(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr2418(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2419(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr2420(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2421(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr2422(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr2423(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
...
cdf_prim_init(void)
{
	...
	
	{
		...
		err = mk_func(&k, ptr2410, ptr2411, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2412, ptr2417, 1);
	...
	
	{
		...
		err = mk_func(&k, ptr2422, ptr2423, 1);
	...
	
	{
		...
		err = mk_func(&k, ptr2424, ptr2425, 1);
	...
	
	{
		...
		err = mk_moper(&k, ptr2426, ptr2427, ptr2428, ptr2429, 1);
	...
	
	{
		...
		err = mk_moper(&k, ptr2430, ptr2431, ptr2432, ptr2433, 3);
	...
	
	{
		...
		err = mk_func(&k, ptr2434, ptr2435, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2436, ptr2437, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2440, ptr2441, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2442, ptr2443, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2446, ptr2447, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2444, ptr2445, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2450, ptr2453, 1);
	...
	
	{
		...
		err = mk_func(&k, ptr2456, ptr2457, 1);
	...
	
	{
		...
		err = mk_func(&k, ptr2464, ptr2465, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2466, ptr2467, 1);
	...
	
	{
		...
		err = mk_func(&k, ptr2470, ptr2471, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2480, ptr2481, 0);
	...
	
	{
		...
		err = mk_moper(&k, ptr2484, ptr2485, ptr2486, ptr2487, 2);
	...
	
	{
		...
		err = mk_moper(&k, ptr2488, ptr2489, ptr2490, ptr2491, 1);
	...
	
	{
		...
		err = mk_moper(&k, ptr2492, ptr2495, ptr2498, ptr2501, 0);
	...
	
	{
		...
		err = mk_doper(&k, ptr2504, ptr2505, ptr2506, ptr2507, ptr2508, ptr2509, ptr2510, ptr2511, 0);
	...
	
	{
		...
		err = mk_doper(&k, ptr2512, ptr2513, ptr2514, ptr2515, ptr2516, ptr2517, ptr2518, ptr2519, 0);
    ...
    struct cell_func *self)
{
...

	{
		...
		err = mk_func(&k, ptr2413, ptr2414, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2415, ptr2416, 1);
    ...
    struct cell_func *self)
{
...

	{
		...
		err = mk_func(&k, ptr2418, ptr2419, 0);
	...
	
	{
		...
		err = mk_func(&k, ptr2420, ptr2421, 1);
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		err = mk_func(&k, ptr2451, ptr2452, 0);
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		err = mk_func(&k, ptr2493, ptr2494, 2);
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		err = mk_func(&k, ptr2496, ptr2497, 2);
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		err = mk_func(&k, ptr2499, ptr2500, 2);
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		err = mk_func(&k, ptr2502, ptr2503, 2);
    ...
    struct cell_func *self)
{
	...
	{
		struct cell_array *x = alphaalpha;
		struct cell_func *fn = cdf_prim.rdf;
		struct cell_array *y = *--stkhd;
		struct cell_array *dst;
