...
cdf_prim_init(void)
{
	...
	
	{
		...
		CHK(mk_func(&k, ptr2448, ptr2449, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2450, ptr2455, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2460, ptr2461, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2462, ptr2463, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr2464, ptr2465, ptr2466, ptr2467, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr2468, ptr2469, ptr2470, ptr2471, 3), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2472, ptr2473, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2474, ptr2475, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2476, ptr2477, 1), cleanup, L"");
	...
	
	{
		...
		TRC(apply_dop(&dst, op, op->fptr_ffm, op->fptr_ffd, x, y), L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2478, ptr2479, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2480, ptr2481, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2484, ptr2485, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2482, ptr2483, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2486, ptr2487, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2488, ptr2491, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2494, ptr2495, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2496, ptr2497, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2498, ptr2499, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2502, ptr2503, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2500, ptr2501, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2504, ptr2505, 1), cleanup, L"");
	...
	
	{
		...
		TRC(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2506, ptr2507, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2508, ptr2509, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2510, ptr2511, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2512, ptr2513, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2514, ptr2515, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2516, ptr2517, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2518, ptr2519, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2520, ptr2521, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr2522, ptr2523, ptr2524, ptr2525, 2), cleanup, L"");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr2526, ptr2527, ptr2528, ptr2529, 1), cleanup, L"");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr2530, ptr2533, ptr2536, ptr2539, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2542, ptr2543, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr2544, ptr2545, ptr2546, ptr2547, ptr2548, ptr2549, ptr2550, ptr2551, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr2552, ptr2553, ptr2554, ptr2555, ptr2556, ptr2557, ptr2558, ptr2559, 0), cleanup, L"");
		...
		if (!err) {
			{
				...
				CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"");
			
			
				CHK(fill_array(arr, dat), cleanup, L"");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_func(&k, ptr2451, ptr2452, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2453, ptr2454, 1), cleanup, L"");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_func(&k, ptr2456, ptr2457, 0), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2458, ptr2459, 1), cleanup, L"");
		...
		if (!err) {
			{
				...
				CHK(mk_array(&arr, ARR_NESTED, STG_HOST, 1), cleanup, L"");
				arr->shape[0] = 3;
				dat = arr->values;
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		CHK(mk_func(&k, ptr2489, ptr2490, 0), cleanup, L"");
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		CHK(mk_func(&k, ptr2492, ptr2493, 0), cleanup, L"");
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		TRC(apply_mop(&dst, op, op->fptr_am, op->fptr_ad, x), L"");
    ...
    struct cell_func *self)
{
	...
	loc->c = NULL;
	loc->zs = NULL;
	CHK(mk_array_box(&loc->z, NULL), cleanup, L"");
	...
	
	{
		...
		CHK(mk_func(&k, ptr2531, ptr2532, 2), cleanup, L"");
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		TRC((fn->fptr_dya)(&bx->value, x, y, fn), L"");
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		CHK(mk_func(&k, ptr2534, ptr2535, 2), cleanup, L"");
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		CHK(mk_func(&k, ptr2537, ptr2538, 2), cleanup, L"");
    ...
    struct cell_func *self)
{
	...
	
	{
		...
		CHK(mk_func(&k, ptr2540, ptr2541, 2), cleanup, L"");
