...
cdf_prim_init(void)
{
	...
	*stkhd++ = retain_cell(is_integer_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4336, ptr4337, 1), cleanup, 
	...
	*stkhd++ = retain_cell(has_nat_vals_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4338, ptr4339, 0), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4340, ptr4345, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4350, ptr4351, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4352, ptr4353, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4354, ptr4355, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4356, ptr4357, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4358, ptr4359, ptr4360, ptr4361, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4362, ptr4363, ptr4364, ptr4365, 3), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4366, ptr4367, 0), cleanup, 
		    L"[32] rgt←╠{⍵}╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4370, ptr4371, 0), cleanup, 
		    L"[35] lft←{⍵} ⎕AMBIV ╠{⍺}╣");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4368, ptr4369, 0), cleanup, 
		    L"[35] lft←╠{⍵}╣ ⎕AMBIV {⍺}");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4372, ptr4373, 1), cleanup, 
	...
	*stkhd++ = retain_cell(shape_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4374, ptr4375, 0), cleanup, 
	...
	*stkhd++ = retain_cell(ravel_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4376, ptr4379, 1), cleanup, 
		    L"[45] depth←╠{╣");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4382, ptr4383, 0), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4384, ptr4385, 0), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4386, ptr4389, 1), cleanup, 
	...
	*stkhd++ = retain_cell(loc->materialize);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4392, ptr4393, 1), cleanup, 
		    L"[64] index_gen←╠{╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4394, ptr4395, 0), cleanup, 
	...
	*stkhd++ = retain_cell(loc->index_gen);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4396, ptr4397, 0), cleanup, 
	...
	*stkhd++ = retain_cell(disclose_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4398, ptr4399, 0), cleanup, 
		    L"[78] enclose←╠{╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4400, ptr4401, 0), cleanup, 
	...
	*stkhd++ = retain_cell(loc->enclose);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4402, ptr4403, 1), cleanup, 
	...
	*stkhd++ = retain_cell(loc->conjugate);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4404, ptr4405, 0), cleanup, 
	...
	*stkhd++ = retain_cell(loc->negate);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4406, ptr4407, 0), cleanup, 
		    L"[93] sign←╠{⎕SIGNAL 16}╣");
	...
	*stkhd++ = retain_cell(loc->sign);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4408, ptr4409, 0), cleanup, 
	...
	*stkhd++ = retain_cell(loc->recip);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4410, ptr4411, 1), cleanup, 
		    L"[101] absolute←╠{╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4412, ptr4413, 0), cleanup, 
	...
	*stkhd++ = retain_cell(loc->pitimes);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[130] fac←'factorial_vec_ibeam'⌶ ⎕AMBIV ('binomial_vec_ibeam'⌶ numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(binomial_vec_ibeam);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[130] fac←'factorial_vec_ibeam'⌶ ⎕AMBIV (╠'binomial_vec_ibeam'⌶ numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(factorial_vec_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4418, ptr4419, 1), cleanup, 
		    L"[133] notscl←╠{is_bool ⍵:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL 11}╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4420, ptr4421, 0), cleanup, 
		    L"[134] without←╠{⎕SIGNAL 16}╣");
	...
	if (!loc->without)
		CHK(6, cleanup, L"[135] not←notscl ⎕AMBIV ╠without╣");
	...
	*stkhd++ = retain_cell(loc->notscl);
	
	{
		...
		CHK(apply_dop(&dst, op, op->fptr_ffm, op->fptr_ffd, x, y), cleanup,
		    L"[135] not←╠notscl ⎕AMBIV without╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4422, ptr4423, 1), cleanup, 
		    L"[138] logand←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[142] and←{⎕SIGNAL 2}⎕AMBIV (logand numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->logand);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[142] and←{⎕SIGNAL 2}⎕AMBIV (╠logand numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[149] lor←{⎕SIGNAL 2}⎕AMBIV (logor numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->logor);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[149] lor←{⎕SIGNAL 2}⎕AMBIV (╠logor numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4428, ptr4429, 0), cleanup, 
		    L"[149] lor←╠{⎕SIGNAL 2}╣⎕AMBIV (logor numeric scalar)");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4432, ptr4433, 1), cleanup, 
		    L"[152] nan←{⎕SIGNAL 2}⎕AMBIV╠{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}╣");
	...
	if (!cdf_prim.q_ambiv)
		CHK(6, cleanup, L"[152] nan←{⎕SIGNAL 2}╠⎕AMBIV╣{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4430, ptr4431, 0), cleanup, 
		    L"[152] nan←╠{⎕SIGNAL 2}╣⎕AMBIV{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4436, ptr4437, 1), cleanup, 
		    L"[155] nor←{⎕SIGNAL 2}⎕AMBIV╠{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}╣");
	...
	if (!cdf_prim.q_ambiv)
		CHK(6, cleanup, L"[155] nor←{⎕SIGNAL 2}╠⎕AMBIV╣{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4434, ptr4435, 0), cleanup, 
		    L"[155] nor←╠{⎕SIGNAL 2}╣⎕AMBIV{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4438, ptr4439, 0), cleanup, 
		    L"[158] lessthan←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[162] lth←{⎕SIGNAL 2} ⎕AMBIV (lessthan numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->lessthan);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[162] lth←{⎕SIGNAL 2} ⎕AMBIV (╠lessthan numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4440, ptr4441, 0), cleanup, 
		    L"[162] lth←╠{⎕SIGNAL 2}╣ ⎕AMBIV (lessthan numeric scalar)");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4442, ptr4443, 0), cleanup, 
		    L"[165] lesseql←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[169] lte←{⎕SIGNAL 2}⎕AMBIV (lesseql numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->lesseql);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[169] lte←{⎕SIGNAL 2}⎕AMBIV (╠lesseql numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	if (!eql_vec_ibeam)
		CHK(6, cleanup, L"[172] eql_vec←╠'eql_vec_ibeam'⌶╣");
	...
	*stkhd++ = retain_cell(eql_vec_ibeam);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[178] eql←{⎕SIGNAL 2}⎕AMBIV (equal ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->equal);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[178] eql←{⎕SIGNAL 2}⎕AMBIV ╠(equal scalar)╣");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4450, ptr4451, 0), cleanup, 
		    L"[181] greatereql←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[185] gte←{⎕SIGNAL 2}⎕AMBIV (greatereql numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->greatereql);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[185] gte←{⎕SIGNAL 2}⎕AMBIV (╠greatereql numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4454, ptr4455, 0), cleanup, 
		    L"[188] greaterthan←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[192] gth←{⎕SIGNAL 2}⎕AMBIV (greaterthan numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->greaterthan);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[192] gth←{⎕SIGNAL 2}⎕AMBIV (╠greaterthan numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4456, ptr4457, 0), cleanup, 
		    L"[192] gth←╠{⎕SIGNAL 2}╣⎕AMBIV (greaterthan numeric scalar)");
	...
	if (!neq_vec_ibeam)
		CHK(6, cleanup, L"[196] neq_vec←╠'neq_vec_ibeam'⌶╣");
	...
	*stkhd++ = retain_cell(neq_vec_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4460, ptr4461, 3), cleanup, 
		    L"[197] noteq←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[202] neq←firstocc ⎕AMBIV (noteq ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->noteq);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[202] neq←firstocc ⎕AMBIV ╠(noteq scalar)╣");
	...
	*stkhd++ = retain_cell(loc->firstocc);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4464, ptr4465, 0), cleanup, 
		    L"[206] drop←╠{(⊂⍺+⍳(≢⍵)-⍺)⌷⍵}╣");
	...
	if (!loc->drop)
		CHK(6, cleanup, L"[207] drp←split ⎕AMBIV ╠drop╣");
	...
	*stkhd++ = retain_cell(loc->split);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4466, ptr4467, 0), cleanup, 
		    L"[210] reverse_last←╠{(⊂(≢⍵)-1+⍳≢⍵)⌷⍵}╣");
	...
	if (!loc->rotate_last)
		CHK(6, cleanup, L"[212] rot←reverse_last ⎕AMBIV ╠rotate_last╣");
	...
	*stkhd++ = retain_cell(loc->reverse_last);
	
	{
		...
		CHK(apply_dop(&dst, op, op->fptr_ffm, op->fptr_ffd, x, y), cleanup,
		    L"[212] rot←╠reverse_last ⎕AMBIV rotate_last╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4470, ptr4471, 0), cleanup, 
		    L"[215] map_monadic←╠{⎕SIGNAL 16}╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4472, ptr4473, ptr4474, ptr4475, 2), cleanup, 
		    L"[216] map_dyadic←╠{⍺ chk_scl ⍵: ⋄ s←⍺ max_shp ⍵ ⋄ s⍴⍺ ⍺⍺ ⎕VEACH ⍵}╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4476, ptr4477, ptr4478, ptr4479, 1), cleanup, 
		    L"[217] map←╠{⍺ ⍺⍺ map_dyadic ⍵}╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4480, ptr4483, ptr4486, ptr4489, 0), cleanup, 
		    L"[220] reduce←╠{╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4492, ptr4495, ptr4498, ptr4501, 1), cleanup, 
		    L"[225] nwreduce←╠{op←⍺⍺¨╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4504, ptr4505, ptr4506, ptr4507, 2), cleanup, 
		    L"[229] rdf←╠{⍺←⊢ ⋄ 1<≢⍴⍺⊣0:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5╣");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr4510, ptr4511, ptr4512, ptr4513, ptr4514, ptr4515, ptr4516, ptr4517, 0), cleanup, 
		    L"[237] dot←╠{⍺⍺⌿⍺ ⍵⍵¨ ⍵}╣");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr4518, ptr4519, ptr4520, ptr4521, ptr4522, ptr4523, ptr4524, ptr4525, 0), cleanup, 
		    L"[240] pow←╠{0≡⍵⍵:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}╣");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr4526, ptr4527, ptr4528, ptr4529, ptr4530, ptr4531, ptr4532, ptr4533, 0), cleanup, 
		    L"[243] jot←╠{╣");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(omega);
	
	{
		...
		CHK(mk_func(&k, ptr4343, ptr4344, 1), cleanup, 
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(omega);
	
	{
		...
		CHK(mk_func(&k, ptr4348, ptr4349, 1), cleanup, 
		    L"[21] 	╠{has_nat_vals ⍵:0 ⋄ 1}╣⍵:⎕SIGNAL 11");
		...
		if (!err) {
			...
			*stkhd++ = retain_cell(omega);
			
			{
				...
				CHK(mk_func(&k, ptr4380, ptr4381, 0), cleanup, 
				    L"[46] 	is_simple ⍵:╠{0≡≢⍴⍵:0 ⋄ 1}╣⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(loc->rnk);
	
	{
		...
		CHK(mk_func(&k, ptr4390, ptr4391, 0), cleanup, 
		    L"[58] 	╠{0≡⍵:0 ⋄ 1≡⍵:0 ⋄ 1}╣rnk:⎕SIGNAL 16");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[133] notscl←{is_bool ╠⍵╣:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL 11}");
	...
	*stkhd++ = retain_cell(lex->is_bool->value);
	...
	
	{
		...
		TRC(guard_check(x), L"[133] notscl←{is_bool ╠⍵╣:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL 11}");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[133] notscl←{is_bool ⍵:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL ╠11╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[133] notscl←{is_bool ⍵:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL ╠11╣}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[134] without←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[134] without←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[134] without←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[139] 	⍺ both_bool ╠⍵╣:⍺('and_vec_ibeam'⌶)⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[139] 	⍺ both_bool ╠⍵╣:⍺('and_vec_ibeam'⌶)⍵");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[142] and←{⎕SIGNAL ╠2╣}⎕AMBIV (logand numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[142] and←{⎕SIGNAL ╠2╣}⎕AMBIV (logand numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[146] 	⍺ both_bool ╠⍵╣:⍺('lor_vec_ibeam'⌶)⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[146] 	⍺ both_bool ╠⍵╣:⍺('lor_vec_ibeam'⌶)⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[147] 	⎕SIGNAL ╠16╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[147] 	⎕SIGNAL ╠16╣");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[147] 	╠⎕SIGNAL╣ 16");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[149] lor←{⎕SIGNAL ╠2╣}⎕AMBIV (logor numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[149] lor←{⎕SIGNAL ╠2╣}⎕AMBIV (logor numeric scalar)");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[152] nan←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
	
		CHK(fill_array(arr, dat), cleanup, L"[152] nan←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[152] nan←{⎕SIGNAL 2}⎕AMBIV{⍺ both_bool ╠⍵╣:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[155] nor←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
	
		CHK(fill_array(arr, dat), cleanup, L"[155] nor←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[155] nor←{⎕SIGNAL 2}⎕AMBIV{⍺ both_bool ╠⍵╣:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[159] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[159] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[159] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[159] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[159] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[160] 	⍺('lth_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[162] lth←{⎕SIGNAL ╠2╣} ⎕AMBIV (lessthan numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[162] lth←{⎕SIGNAL ╠2╣} ⎕AMBIV (lessthan numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[167] 	⍺('lte_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[169] lte←{⎕SIGNAL ╠2╣}⎕AMBIV (lesseql numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[169] lte←{⎕SIGNAL ╠2╣}⎕AMBIV (lesseql numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[174] 	⍺ both_numeric ╠⍵╣:⍺ eql_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[174] 	⍺ both_numeric ╠⍵╣:⍺ eql_vec ⍵");
	...
	if (!omega)
		CHK(6, cleanup, L"[175] 	⍺ both_char ╠⍵╣:⍺ eql_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[175] 	⍺ both_char ╠⍵╣:⍺ eql_vec ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[176] 	╠0╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[176] 	╠0╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[178] eql←{⎕SIGNAL ╠2╣}⎕AMBIV (equal scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[178] eql←{⎕SIGNAL ╠2╣}⎕AMBIV (equal scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[182] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[182] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[182] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[182] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[182] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[183] 	⍺('gte_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[185] gte←{⎕SIGNAL ╠2╣}⎕AMBIV (greatereql numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[185] gte←{⎕SIGNAL ╠2╣}⎕AMBIV (greatereql numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[189] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[189] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[189] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[189] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[189] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[190] 	⍺('gth_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[192] gth←{⎕SIGNAL ╠2╣}⎕AMBIV (greaterthan numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[192] gth←{⎕SIGNAL ╠2╣}⎕AMBIV (greaterthan numeric scalar)");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[195] firstocc←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[195] firstocc←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[195] firstocc←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[198] 	⍺ both_numeric ╠⍵╣:⍺ neq_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[198] 	⍺ both_numeric ╠⍵╣:⍺ neq_vec ⍵");
	...
	if (!omega)
		CHK(6, cleanup, L"[199] 	⍺ both_char ╠⍵╣:⍺ neq_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[199] 	⍺ both_char ╠⍵╣:⍺ neq_vec ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[200] 	╠1╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[200] 	╠1╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[205] split←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[205] split←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[205] split←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[210] reverse_last←{(⊂(≢⍵)-1+⍳≢⍵)⌷╠⍵╣}");
	...
	*stkhd++ = retain_cell(cdf_prim.add);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[210] reverse_last←{(⊂(≢⍵)-╠1╣+⍳≢⍵)⌷⍵}");
	
		CHK(fill_array(arr, dat), cleanup, L"[210] reverse_last←{(⊂(≢⍵)-╠1╣+⍳≢⍵)⌷⍵}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[211] rotate_last←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[211] rotate_last←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[211] rotate_last←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[215] map_monadic←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[215] map_monadic←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[215] map_monadic←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[216] map_dyadic←{⍺ chk_scl ╠⍵╣: ⋄ s←⍺ max_shp ⍵ ⋄ s⍴⍺ ⍺⍺ ⎕VEACH ⍵}");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[216] map_dyadic←{⍺ chk_scl ╠⍵╣: ⋄ s←⍺ max_shp ⍵ ⋄ s⍴⍺ ⍺⍺ ⎕VEACH ⍵}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[217] map←{⍺ ⍺⍺ map_dyadic ╠⍵╣}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[221] 	0≡≢⍴╠⍵╣:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[221] 	╠0╣≡≢⍴⍵:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	
		CHK(fill_array(arr, dat), cleanup, L"[221] 	╠0╣≡≢⍴⍵:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	...
	
	{
		...
		TRC(guard_check(x), L"[221] 	0≡≢⍴╠⍵╣:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	...
	*stkhd++ = retain_cell(cdf_prim.drp);
	...
	if (!loc->c)
		CHK(6, cleanup, L"[222] 	0≡╠c╣:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[222] 	╠0╣≡c:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	
		CHK(fill_array(arr, dat), cleanup, L"[222] 	╠0╣≡c:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	...
	
	{
		...
		TRC(guard_check(x), L"[222] 	0≡╠c╣:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	...
	*stkhd++ = retain_cell(alphaalpha);
	...
	if (!omega)
		CHK(6, cleanup, L"[223] 	z⊣(⌽⍳c-1){⍬⊣z⊢←(⍺⌷⍵)op z}¨⊂⍵⊣z←(c-1)⌷╠⍵╣");
	...
	*stkhd++ = retain_cell(cdf_prim.sqd);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[223] 	z⊣(⌽⍳c-1){⍬⊣z⊢←(⍺⌷⍵)op z}¨⊂⍵⊣z←(c-╠1╣)⌷⍵");
	
		CHK(fill_array(arr, dat), cleanup, L"[223] 	z⊣(⌽⍳c-1){⍬⊣z⊢←(⍺⌷⍵)op z}¨⊂⍵⊣z←(c-╠1╣)⌷⍵");
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4481, ptr4482, 2), cleanup, 
		    L"[223] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4484, ptr4485, 2), cleanup, 
		    L"[223] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4487, ptr4488, 2), cleanup, 
		    L"[223] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4490, ptr4491, 2), cleanup, 
		    L"[223] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	if (!cdf_prim.map)
		CHK(6, cleanup, L"[225] nwreduce←{op←⍺⍺╠¨╣");
	...
	*stkhd++ = retain_cell(alphaalpha);
	...
	if (!alpha)
		CHK(6, cleanup, L"[226] 	0≡is_integer ╠⍺╣:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	*stkhd++ = retain_cell(lex->is_integer->value);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[226] 	0≡╠is_integer ⍺╣:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[226] 	╠0╣≡is_integer ⍺:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	
		CHK(fill_array(arr, dat), cleanup, L"[226] 	╠0╣≡is_integer ⍺:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	
	{
		...
		TRC(guard_check(x), L"[226] 	0≡is_integer ╠⍺╣:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	*stkhd++ = retain_cell(cdf_prim.sub);
	...
	if (!omega)
		CHK(6, cleanup, L"[227] 	z⊣(⌽⍳⍺-1){z⊢←((⊂⍺+⍳rc)⌷⍵)op z}¨⊂⍵⊣z←(⍺-1)↓╠⍵╣");
	...
	*stkhd++ = retain_cell(cdf_prim.drp);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[227] 	z⊣(⌽⍳⍺-1){z⊢←((⊂⍺+⍳rc)⌷⍵)op z}¨⊂⍵⊣z←(⍺-╠1╣)↓⍵");
	
		CHK(fill_array(arr, dat), cleanup, L"[227] 	z⊣(⌽⍳⍺-1){z⊢←((⊂⍺+⍳rc)⌷⍵)op z}¨⊂⍵⊣z←(⍺-╠1╣)↓⍵");
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4493, ptr4494, 3), cleanup, 
		    L"[227] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4496, ptr4497, 3), cleanup, 
		    L"[227] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4499, ptr4500, 3), cleanup, 
		    L"[227] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4502, ptr4503, 3), cleanup, 
		    L"[227] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	if (!cdf_prim.rgt)
		CHK(6, cleanup, L"[229] rdf←{⍺←╠⊢╣ ⋄ 1<≢⍴⍺⊣0:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	...
	*stkhd++ = retain_cell(cdf_prim.rgt);
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[229] rdf←{⍺←⊢ ⋄ 1<≢⍴⍺⊣╠0╣:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	
		CHK(fill_array(arr, dat), cleanup, L"[229] rdf←{⍺←⊢ ⋄ 1<≢⍴⍺⊣╠0╣:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	...
	*stkhd++ = retain_cell(cdf_prim.lth);
	...
	
	{
		...
		TRC(guard_check(x), L"[229] rdf←{⍺←⊢ ⋄ 1<≢⍴⍺⊣╠0╣:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	...
	*stkhd++ = retain_cell(cdf_prim.nqv);
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[230] 	⍬≡⍺⊣╠⍬╣:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
	
		arr->shape[0] = 0;
	
		CHK(fill_array(arr, dat), cleanup, L"[230] 	⍬≡⍺⊣╠⍬╣:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.lft)
		CHK(6, cleanup, L"[230] 	⍬≡⍺╠⊣╣⍬:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	
	{
		...
		TRC(guard_check(x), L"[230] 	⍬≡⍺⊣╠⍬╣:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[234] rpf←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[234] rpf←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[234] rpf←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[240] pow←{╠0╣≡⍵⍵:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}");
	
		CHK(fill_array(arr, dat), cleanup, L"[240] pow←{╠0╣≡⍵⍵:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}");
	...
	
	{
		...
		TRC(guard_check(x), L"[240] pow←{0≡╠⍵⍵╣:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[244] 	type←╠⎕NC'⍺' '⍺⍺' '⍵⍵'╣");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[244] 	type←╠⎕NC'⍺' '⍺⍺' '⍵⍵'╣");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[245] 	type≡╠2 3 3╣:⍺ ⍺⍺ ⍵⍵ ⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[245] 	type≡╠2 3 3╣:⍺ ⍺⍺ ⍵⍵ ⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[245] 	type╠≡╣2 3 3:⍺ ⍺⍺ ⍵⍵ ⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[245] 	type≡╠2 3 3╣:⍺ ⍺⍺ ⍵⍵ ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[246] 	type≡╠0 3 3╣:⍺⍺ ⍵⍵ ⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[246] 	type≡╠0 3 3╣:⍺⍺ ⍵⍵ ⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[246] 	type╠≡╣0 3 3:⍺⍺ ⍵⍵ ⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[246] 	type≡╠0 3 3╣:⍺⍺ ⍵⍵ ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[247] 	type≡╠0 2 3╣:⍺⍺ ⍵⍵ ⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[247] 	type≡╠0 2 3╣:⍺⍺ ⍵⍵ ⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[247] 	type╠≡╣0 2 3:⍺⍺ ⍵⍵ ⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[247] 	type≡╠0 2 3╣:⍺⍺ ⍵⍵ ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[248] 	type≡╠0 3 2╣:⍵ ⍺⍺ ⍵⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[248] 	type≡╠0 3 2╣:⍵ ⍺⍺ ⍵⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[248] 	type╠≡╣0 3 2:⍵ ⍺⍺ ⍵⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[248] 	type≡╠0 3 2╣:⍵ ⍺⍺ ⍵⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[249] 	⎕SIGNAL ╠2╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[249] 	⎕SIGNAL ╠2╣");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[249] 	╠⎕SIGNAL╣ 2");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		if (!err) {
			CHK(2, cleanup, L"[248] 	type≡0 3 2:╠⍵ ⍺⍺ ⍵⍵╣");
