...
int ptr4488(struct cell_array **,
    ...
    struct cell_array *,
    struct cell_func *);
int ptr4489(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4490(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4491(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4492(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4493(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4494(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4495(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4496(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4497(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4498(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4499(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4500(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4501(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4502(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4503(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4504(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4505(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4506(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4507(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4508(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4509(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4510(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4511(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4512(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4513(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4514(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
int ptr4515(struct cell_array **,
    struct cell_array *,
    struct cell_func *);
int ptr4516(struct cell_array **,
    struct cell_array *,
    struct cell_array *,
    struct cell_func *);
...
wchar_t *cdf_prim_names[] = {L"q_signal", L"q_dr", L"q_veach", L"q_ambiv", L"squeeze", L"is_simple", L"is_numeric", L"is_char", L"is_integer", L"is_bool", L"max_shp", L"has_nat_vals", L"chk_scl", L"chk_valid_shape", L"both_simple", L"both_numeric", L"both_char", L"both_bool", L"numeric", L"scalar", L"rgt", L"lft", L"reshape", L"rho", L"cat", L"depth", L"eqv", L"nqv", L"materialize", L"index", L"sqd", L"index_gen", L"index_of", L"iot", L"dis", L"enclose", L"par", L"conjugate", L"add", L"negate", L"sub", L"sign", L"mul", L"recip", L"div", L"absolute", L"residue", L"res", L"floor_array", L"min", L"max", L"exp", L"log", L"cir", L"fac", L"notscl", L"without", L"not", L"logand", L"and", L"logor", L"lor", L"nan", L"nor", L"lessthan", L"lth", L"lesseql", L"lte", L"eql_vec", L"equal", L"eql", L"greatereql", L"gte", L"greaterthan", L"gth", L"firstocc", L"neq_vec", L"noteq", L"neq", L"split", L"drop", L"drp", L"reverse_last", L"rotate_last", L"rot", L"map_monadic", L"map_dyadic", L"map", L"reduce", L"nwreduce", L"rdf", L"rpf", L"dot", L"pow", L"jot"};
...
cdf_prim_init(void)
{
	...
	*stkhd++ = retain_cell(is_integer_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4321, ptr4322, 1), cleanup, 
	...
	*stkhd++ = retain_cell(has_nat_vals_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4325, ptr4330, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4335, ptr4336, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4337, ptr4338, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4339, ptr4340, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_func(&k, ptr4341, ptr4342, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4343, ptr4344, ptr4345, ptr4346, 1), cleanup, 
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4347, ptr4348, ptr4349, ptr4350, 3), cleanup, 
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4357, ptr4358, 1), cleanup, 
	...
	*stkhd++ = retain_cell(ravel_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4361, ptr4364, 1), cleanup, 
		    L"[45] depth←╠{╣");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4371, ptr4374, 1), cleanup, 
	...
	*stkhd++ = retain_cell(loc->recip);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4395, ptr4396, 1), cleanup, 
		    L"[101] absolute←╠{╣");
	...
	*stkhd++ = retain_cell(loc->absolute);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4399, ptr4400, 1), cleanup, 
		    L"[110] floor_array←╠{╣");
	...
	*stkhd++ = retain_cell(nlg_vec_ibeam);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[126] cir←'pitimes_vec_ibeam'⌶ ⎕AMBIV ('trig_vec_ibeam'⌶ numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(trig_vec_ibeam);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[126] cir←'pitimes_vec_ibeam'⌶ ⎕AMBIV (╠'trig_vec_ibeam'⌶ numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(pitimes_vec_ibeam);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[129] fac←'factorial_vec_ibeam'⌶ ⎕AMBIV ('binomial_vec_ibeam'⌶ numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(binomial_vec_ibeam);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[129] fac←'factorial_vec_ibeam'⌶ ⎕AMBIV (╠'binomial_vec_ibeam'⌶ numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(factorial_vec_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4401, ptr4402, 1), cleanup, 
		    L"[132] notscl←╠{is_bool ⍵:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL 11}╣");
	...
	if (!loc->without)
		CHK(6, cleanup, L"[134] not←notscl ⎕AMBIV ╠without╣");
	...
	*stkhd++ = retain_cell(loc->notscl);
	
	{
		...
		CHK(apply_dop(&dst, op, op->fptr_ffm, op->fptr_ffd, x, y), cleanup,
		    L"[134] not←╠notscl ⎕AMBIV without╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4405, ptr4406, 1), cleanup, 
		    L"[137] logand←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[141] and←{⎕SIGNAL 2}⎕AMBIV (logand numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->logand);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[141] and←{⎕SIGNAL 2}⎕AMBIV (╠logand numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4409, ptr4410, 1), cleanup, 
		    L"[144] logor←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[148] lor←{⎕SIGNAL 2}⎕AMBIV (logor numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->logor);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[148] lor←{⎕SIGNAL 2}⎕AMBIV (╠logor numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4415, ptr4416, 1), cleanup, 
		    L"[151] nan←{⎕SIGNAL 2}⎕AMBIV╠{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}╣");
	...
	if (!cdf_prim.q_ambiv)
		CHK(6, cleanup, L"[151] nan←{⎕SIGNAL 2}╠⎕AMBIV╣{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4419, ptr4420, 1), cleanup, 
		    L"[154] nor←{⎕SIGNAL 2}⎕AMBIV╠{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}╣");
	...
	if (!cdf_prim.q_ambiv)
		CHK(6, cleanup, L"[154] nor←{⎕SIGNAL 2}╠⎕AMBIV╣{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[161] lth←{⎕SIGNAL 2} ⎕AMBIV (lessthan numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->lessthan);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[161] lth←{⎕SIGNAL 2} ⎕AMBIV (╠lessthan numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[168] lte←{⎕SIGNAL 2}⎕AMBIV (lesseql numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->lesseql);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[168] lte←{⎕SIGNAL 2}⎕AMBIV (╠lesseql numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4427, ptr4428, 0), cleanup, 
		    L"[168] lte←╠{⎕SIGNAL 2}╣⎕AMBIV (lesseql numeric scalar)");
	...
	if (!eql_vec_ibeam)
		CHK(6, cleanup, L"[171] eql_vec←╠'eql_vec_ibeam'⌶╣");
	...
	*stkhd++ = retain_cell(eql_vec_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4429, ptr4430, 3), cleanup, 
		    L"[172] equal←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[177] eql←{⎕SIGNAL 2}⎕AMBIV (equal ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->equal);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[177] eql←{⎕SIGNAL 2}⎕AMBIV ╠(equal scalar)╣");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4431, ptr4432, 0), cleanup, 
		    L"[177] eql←╠{⎕SIGNAL 2}╣⎕AMBIV (equal scalar)");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4433, ptr4434, 0), cleanup, 
		    L"[180] greatereql←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[184] gte←{⎕SIGNAL 2}⎕AMBIV (greatereql numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->greatereql);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[184] gte←{⎕SIGNAL 2}⎕AMBIV (╠greatereql numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4435, ptr4436, 0), cleanup, 
		    L"[184] gte←╠{⎕SIGNAL 2}╣⎕AMBIV (greatereql numeric scalar)");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4437, ptr4438, 0), cleanup, 
		    L"[187] greaterthan←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[191] gth←{⎕SIGNAL 2}⎕AMBIV (greaterthan numeric ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->greaterthan);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[191] gth←{⎕SIGNAL 2}⎕AMBIV (╠greaterthan numeric╣ scalar)");
	...
	*stkhd++ = retain_cell(cdf_prim.q_ambiv);
	
	{
		...
		CHK(mk_func(&k, ptr4439, ptr4440, 0), cleanup, 
		    L"[191] gth←╠{⎕SIGNAL 2}╣⎕AMBIV (greaterthan numeric scalar)");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4441, ptr4442, 0), cleanup, 
		    L"[194] firstocc←╠{⎕SIGNAL 16}╣");
	...
	if (!neq_vec_ibeam)
		CHK(6, cleanup, L"[195] neq_vec←╠'neq_vec_ibeam'⌶╣");
	...
	*stkhd++ = retain_cell(neq_vec_ibeam);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4443, ptr4444, 3), cleanup, 
		    L"[196] noteq←╠{╣");
	...
	if (!loc->scalar)
		CHK(6, cleanup, L"[201] neq←firstocc ⎕AMBIV (noteq ╠scalar╣)");
	...
	*stkhd++ = retain_cell(loc->noteq);
	
	{
		...
		CHK(apply_mop(&dst, op, op->fptr_fm, op->fptr_fd, x), cleanup,
		    L"[201] neq←firstocc ⎕AMBIV ╠(noteq scalar)╣");
	...
	*stkhd++ = retain_cell(loc->firstocc);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4445, ptr4446, 0), cleanup, 
		    L"[204] split←╠{⎕SIGNAL 16}╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4447, ptr4448, 0), cleanup, 
		    L"[205] drop←╠{(⊂⍺+⍳(≢⍵)-⍺)⌷⍵}╣");
	...
	if (!loc->drop)
		CHK(6, cleanup, L"[206] drp←split ⎕AMBIV ╠drop╣");
	...
	*stkhd++ = retain_cell(loc->split);
	...
	
	{
		...
		CHK(mk_func(&k, ptr4449, ptr4450, 0), cleanup, 
		    L"[209] reverse_last←╠{(⊂(≢⍵)-1+⍳≢⍵)⌷⍵}╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4451, ptr4452, 0), cleanup, 
		    L"[210] rotate_last←╠{⎕SIGNAL 16}╣");
	...
	if (!loc->rotate_last)
		CHK(6, cleanup, L"[211] rot←reverse_last ⎕AMBIV ╠rotate_last╣");
	...
	*stkhd++ = retain_cell(loc->reverse_last);
	
	{
		...
		CHK(apply_dop(&dst, op, op->fptr_ffm, op->fptr_ffd, x, y), cleanup,
		    L"[211] rot←╠reverse_last ⎕AMBIV rotate_last╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4453, ptr4454, 0), cleanup, 
		    L"[214] map_monadic←╠{⎕SIGNAL 16}╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4455, ptr4456, ptr4457, ptr4458, 2), cleanup, 
		    L"[215] map_dyadic←╠{⍺ chk_scl ⍵: ⋄ s←⍺ max_shp ⍵ ⋄ s⍴⍺ ⍺⍺ ⎕VEACH ⍵}╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4459, ptr4460, ptr4461, ptr4462, 1), cleanup, 
		    L"[216] map←╠{⍺ ⍺⍺ map_dyadic ⍵}╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4463, ptr4466, ptr4469, ptr4472, 0), cleanup, 
		    L"[219] reduce←╠{╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4475, ptr4478, ptr4481, ptr4484, 1), cleanup, 
		    L"[224] nwreduce←╠{op←⍺⍺¨╣");
	...
	
	{
		...
		CHK(mk_moper(&k, ptr4487, ptr4488, ptr4489, ptr4490, 2), cleanup, 
		    L"[228] rdf←╠{⍺←⊢ ⋄ 1<≢⍴⍺⊣0:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5╣");
	...
	
	{
		...
		CHK(mk_func(&k, ptr4491, ptr4492, 0), cleanup, 
		    L"[233] rpf←╠{⎕SIGNAL 16}╣");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr4493, ptr4494, ptr4495, ptr4496, ptr4497, ptr4498, ptr4499, ptr4500, 0), cleanup, 
		    L"[236] dot←╠{⍺⍺⌿⍺ ⍵⍵¨ ⍵}╣");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr4501, ptr4502, ptr4503, ptr4504, ptr4505, ptr4506, ptr4507, ptr4508, 0), cleanup, 
		    L"[239] pow←╠{0≡⍵⍵:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}╣");
	...
	
	{
		...
		CHK(mk_doper(&k, ptr4509, ptr4510, ptr4511, ptr4512, ptr4513, ptr4514, ptr4515, ptr4516, 0), cleanup, 
		    L"[242] jot←╠{╣");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(omega);
	
	{
		...
		CHK(mk_func(&k, ptr4326, ptr4327, 0), cleanup, 
	...
	*stkhd++ = retain_cell(omega);
	
	{
		...
		CHK(mk_func(&k, ptr4328, ptr4329, 1), cleanup, 
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(omega);
	
	{
		...
		CHK(mk_func(&k, ptr4333, ptr4334, 1), cleanup, 
		    L"[21] 	╠{has_nat_vals ⍵:0 ⋄ 1}╣⍵:⎕SIGNAL 11");
		...
		if (!err) {
			...
			*stkhd++ = retain_cell(omega);
			
			{
				...
				CHK(mk_func(&k, ptr4362, ptr4363, 0), cleanup, 
				    L"[46] 	is_simple ⍵:╠{0≡≢⍴⍵:0 ⋄ 1}╣⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(loc->rnk);
	
	{
		...
		CHK(mk_func(&k, ptr4372, ptr4373, 0), cleanup, 
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[132] notscl←{is_bool ╠⍵╣:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL 11}");
	...
	*stkhd++ = retain_cell(lex->is_bool->value);
	...
	
	{
		...
		TRC(guard_check(x), L"[132] notscl←{is_bool ╠⍵╣:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL 11}");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[132] notscl←{is_bool ⍵:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL ╠11╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[132] notscl←{is_bool ⍵:'not_vec_ibeam'⌶ ⍵ ⋄ ⎕SIGNAL ╠11╣}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[133] without←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[133] without←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[133] without←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[138] 	⍺ both_bool ╠⍵╣:⍺('and_vec_ibeam'⌶)⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[138] 	⍺ both_bool ╠⍵╣:⍺('and_vec_ibeam'⌶)⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[139] 	⎕SIGNAL ╠16╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[139] 	⎕SIGNAL ╠16╣");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[139] 	╠⎕SIGNAL╣ 16");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[141] and←{⎕SIGNAL ╠2╣}⎕AMBIV (logand numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[141] and←{⎕SIGNAL ╠2╣}⎕AMBIV (logand numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[145] 	⍺ both_bool ╠⍵╣:⍺('lor_vec_ibeam'⌶)⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[145] 	⍺ both_bool ╠⍵╣:⍺('lor_vec_ibeam'⌶)⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[146] 	⎕SIGNAL ╠16╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[146] 	⎕SIGNAL ╠16╣");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[146] 	╠⎕SIGNAL╣ 16");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[148] lor←{⎕SIGNAL ╠2╣}⎕AMBIV (logor numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[148] lor←{⎕SIGNAL ╠2╣}⎕AMBIV (logor numeric scalar)");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[151] nan←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
	
		CHK(fill_array(arr, dat), cleanup, L"[151] nan←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[151] nan←{⎕SIGNAL 2}⎕AMBIV{⍺ both_bool ╠⍵╣:~⍺∧⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[154] nor←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
	
		CHK(fill_array(arr, dat), cleanup, L"[154] nor←{⎕SIGNAL ╠2╣}⎕AMBIV{⍺ both_bool ⍵:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[154] nor←{⎕SIGNAL 2}⎕AMBIV{⍺ both_bool ╠⍵╣:~⍺∨⍵ ⋄ ⎕SIGNAL 11}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[158] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[158] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[158] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[158] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[158] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[159] 	⍺('lth_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[161] lth←{⎕SIGNAL ╠2╣} ⎕AMBIV (lessthan numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[161] lth←{⎕SIGNAL ╠2╣} ⎕AMBIV (lessthan numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[165] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[165] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[165] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[165] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[165] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[166] 	⍺('lte_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[168] lte←{⎕SIGNAL ╠2╣}⎕AMBIV (lesseql numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[168] lte←{⎕SIGNAL ╠2╣}⎕AMBIV (lesseql numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[173] 	⍺ both_numeric ╠⍵╣:⍺ eql_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[173] 	⍺ both_numeric ╠⍵╣:⍺ eql_vec ⍵");
	...
	if (!omega)
		CHK(6, cleanup, L"[174] 	⍺ both_char ╠⍵╣:⍺ eql_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[174] 	⍺ both_char ╠⍵╣:⍺ eql_vec ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[175] 	╠0╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[175] 	╠0╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[177] eql←{⎕SIGNAL ╠2╣}⎕AMBIV (equal scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[177] eql←{⎕SIGNAL ╠2╣}⎕AMBIV (equal scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[181] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[181] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[181] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[181] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[181] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[182] 	⍺('gte_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[184] gte←{⎕SIGNAL ╠2╣}⎕AMBIV (greatereql numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[184] gte←{⎕SIGNAL ╠2╣}⎕AMBIV (greatereql numeric scalar)");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[188] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.q_dr);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[188] 	1289≡╠⎕DR ⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[188] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	
		CHK(fill_array(arr, dat), cleanup, L"[188] 	╠1289╣≡⎕DR ⍵:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	
	{
		...
		TRC(guard_check(x), L"[188] 	1289≡⎕DR ╠⍵╣:⎕SIGNAL 11 ⋄ 1289≡⎕DR ⍺:⎕SIGNAL 11");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	if (!omega)
		CHK(6, cleanup, L"[189] 	⍺('gth_vec_ibeam'⌶)╠⍵╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[191] gth←{⎕SIGNAL ╠2╣}⎕AMBIV (greaterthan numeric scalar)");
	
		CHK(fill_array(arr, dat), cleanup, L"[191] gth←{⎕SIGNAL ╠2╣}⎕AMBIV (greaterthan numeric scalar)");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[194] firstocc←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[194] firstocc←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[194] firstocc←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[197] 	⍺ both_numeric ╠⍵╣:⍺ neq_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[197] 	⍺ both_numeric ╠⍵╣:⍺ neq_vec ⍵");
	...
	if (!omega)
		CHK(6, cleanup, L"[198] 	⍺ both_char ╠⍵╣:⍺ neq_vec ⍵");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[198] 	⍺ both_char ╠⍵╣:⍺ neq_vec ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[199] 	╠1╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[199] 	╠1╣");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[204] split←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[204] split←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[204] split←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[209] reverse_last←{(⊂(≢⍵)-1+⍳≢⍵)⌷╠⍵╣}");
	...
	*stkhd++ = retain_cell(cdf_prim.add);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[209] reverse_last←{(⊂(≢⍵)-╠1╣+⍳≢⍵)⌷⍵}");
	
		CHK(fill_array(arr, dat), cleanup, L"[209] reverse_last←{(⊂(≢⍵)-╠1╣+⍳≢⍵)⌷⍵}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[210] rotate_last←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[210] rotate_last←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[210] rotate_last←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[214] map_monadic←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[214] map_monadic←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[214] map_monadic←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[215] map_dyadic←{⍺ chk_scl ╠⍵╣: ⋄ s←⍺ max_shp ⍵ ⋄ s⍴⍺ ⍺⍺ ⎕VEACH ⍵}");
	...
	*stkhd++ = retain_cell(alpha);
	...
	
	{
		...
		TRC(guard_check(x), L"[215] map_dyadic←{⍺ chk_scl ╠⍵╣: ⋄ s←⍺ max_shp ⍵ ⋄ s⍴⍺ ⍺⍺ ⎕VEACH ⍵}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[216] map←{⍺ ⍺⍺ map_dyadic ╠⍵╣}");
    ...
    struct cell_func *self)
{
	...
	if (!omega)
		CHK(6, cleanup, L"[220] 	0≡≢⍴╠⍵╣:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[220] 	╠0╣≡≢⍴⍵:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	
		CHK(fill_array(arr, dat), cleanup, L"[220] 	╠0╣≡≢⍴⍵:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	...
	
	{
		...
		TRC(guard_check(x), L"[220] 	0≡≢⍴╠⍵╣:∇,⍵ ⋄ s←⍴⍵ ⋄ c←⊃s ⋄ zs←1↓s");
	...
	*stkhd++ = retain_cell(cdf_prim.drp);
	...
	if (!loc->c)
		CHK(6, cleanup, L"[221] 	0≡╠c╣:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[221] 	╠0╣≡c:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	
		CHK(fill_array(arr, dat), cleanup, L"[221] 	╠0╣≡c:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	...
	
	{
		...
		TRC(guard_check(x), L"[221] 	0≡╠c╣:⎕SIGNAL 16 ⋄ 1≡c:zs⍴⍵ ⋄ op←⍺⍺¨");
	...
	*stkhd++ = retain_cell(alphaalpha);
	...
	if (!omega)
		CHK(6, cleanup, L"[222] 	z⊣(⌽⍳c-1){⍬⊣z⊢←(⍺⌷⍵)op z}¨⊂⍵⊣z←(c-1)⌷╠⍵╣");
	...
	*stkhd++ = retain_cell(cdf_prim.sqd);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[222] 	z⊣(⌽⍳c-1){⍬⊣z⊢←(⍺⌷⍵)op z}¨⊂⍵⊣z←(c-╠1╣)⌷⍵");
	
		CHK(fill_array(arr, dat), cleanup, L"[222] 	z⊣(⌽⍳c-1){⍬⊣z⊢←(⍺⌷⍵)op z}¨⊂⍵⊣z←(c-╠1╣)⌷⍵");
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4464, ptr4465, 2), cleanup, 
		    L"[222] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4467, ptr4468, 2), cleanup, 
		    L"[222] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4470, ptr4471, 2), cleanup, 
		    L"[222] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4473, ptr4474, 2), cleanup, 
		    L"[222] 	z⊣(⌽⍳c-1)╠{⍬⊣z⊢←(⍺⌷⍵)op z}╣¨⊂⍵⊣z←(c-1)⌷⍵");
    ...
    struct cell_func *self)
{
	...
	if (!cdf_prim.map)
		CHK(6, cleanup, L"[224] nwreduce←{op←⍺⍺╠¨╣");
	...
	*stkhd++ = retain_cell(alphaalpha);
	...
	if (!alpha)
		CHK(6, cleanup, L"[225] 	0≡is_integer ╠⍺╣:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	*stkhd++ = retain_cell(lex->is_integer->value);
	
	{
		...
		CHK((fn->fptr_mon)(&dst, y, fn), cleanup,
		    L"[225] 	0≡╠is_integer ⍺╣:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[225] 	╠0╣≡is_integer ⍺:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	
		CHK(fill_array(arr, dat), cleanup, L"[225] 	╠0╣≡is_integer ⍺:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	
	{
		...
		TRC(guard_check(x), L"[225] 	0≡is_integer ╠⍺╣:⎕SIGNAL 11 ⋄ rc←1+≢⍵ ⋄ rc<⍺:⎕SIGNAL 5 ⋄ rc-←|⍺");
	...
	*stkhd++ = retain_cell(cdf_prim.sub);
	...
	if (!omega)
		CHK(6, cleanup, L"[226] 	z⊣(⌽⍳⍺-1){z⊢←((⊂⍺+⍳rc)⌷⍵)op z}¨⊂⍵⊣z←(⍺-1)↓╠⍵╣");
	...
	*stkhd++ = retain_cell(cdf_prim.drp);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[226] 	z⊣(⌽⍳⍺-1){z⊢←((⊂⍺+⍳rc)⌷⍵)op z}¨⊂⍵⊣z←(⍺-╠1╣)↓⍵");
	
		CHK(fill_array(arr, dat), cleanup, L"[226] 	z⊣(⌽⍳⍺-1){z⊢←((⊂⍺+⍳rc)⌷⍵)op z}¨⊂⍵⊣z←(⍺-╠1╣)↓⍵");
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4476, ptr4477, 3), cleanup, 
		    L"[226] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4479, ptr4480, 3), cleanup, 
		    L"[226] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4482, ptr4483, 3), cleanup, 
		    L"[226] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.map);
	
	{
		...
		CHK(mk_func(&k, ptr4485, ptr4486, 3), cleanup, 
		    L"[226] 	z⊣(⌽⍳⍺-1)╠{z⊢←((⊂⍺+⍳rc)⌷⍵)op z}╣¨⊂⍵⊣z←(⍺-1)↓⍵");
    ...
    struct cell_func *self)
{
	...
	if (!cdf_prim.rgt)
		CHK(6, cleanup, L"[228] rdf←{⍺←╠⊢╣ ⋄ 1<≢⍴⍺⊣0:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	...
	*stkhd++ = retain_cell(cdf_prim.rgt);
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[228] rdf←{⍺←⊢ ⋄ 1<≢⍴⍺⊣╠0╣:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	
		CHK(fill_array(arr, dat), cleanup, L"[228] rdf←{⍺←⊢ ⋄ 1<≢⍴⍺⊣╠0╣:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	...
	*stkhd++ = retain_cell(cdf_prim.lth);
	...
	
	{
		...
		TRC(guard_check(x), L"[228] rdf←{⍺←⊢ ⋄ 1<≢⍴⍺⊣╠0╣:⎕SIGNAL 4 ⋄ 1≢≢,⍺⊣0:⎕SIGNAL 5");
	...
	*stkhd++ = retain_cell(cdf_prim.nqv);
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[229] 	⍬≡⍺⊣╠⍬╣:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
	
		arr->shape[0] = 0;
	
		CHK(fill_array(arr, dat), cleanup, L"[229] 	⍬≡⍺⊣╠⍬╣:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.lft)
		CHK(6, cleanup, L"[229] 	⍬≡⍺╠⊣╣⍬:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	...
	
	{
		...
		TRC(guard_check(x), L"[229] 	⍬≡⍺⊣╠⍬╣:⍺⍺ reduce ⍵ ⋄ ⍺(⍺⍺ nwreduce)⍵");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[233] rpf←{⎕SIGNAL ╠16╣}");
	
		CHK(fill_array(arr, dat), cleanup, L"[233] rpf←{⎕SIGNAL ╠16╣}");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[233] rpf←{╠⎕SIGNAL╣ 16}");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(cdf_prim.eqv);
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[239] pow←{╠0╣≡⍵⍵:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}");
	
		CHK(fill_array(arr, dat), cleanup, L"[239] pow←{╠0╣≡⍵⍵:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}");
	...
	
	{
		...
		TRC(guard_check(x), L"[239] pow←{0≡╠⍵⍵╣:⍵ ⋄ ⍺←⊢ ⋄ ⍺ ⍺⍺∇∇(⍵⍵-1)⊢⍺ ⍺⍺ ⍵}");
    ...
    struct cell_func *self)
{
...

	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[243] 	type←╠⎕NC'⍺' '⍺⍺' '⍵⍵'╣");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[243] 	type←╠⎕NC'⍺' '⍺⍺' '⍵⍵'╣");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[244] 	type≡╠2 3 3╣:⍺ ⍺⍺ ⍵⍵ ⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[244] 	type≡╠2 3 3╣:⍺ ⍺⍺ ⍵⍵ ⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[244] 	type╠≡╣2 3 3:⍺ ⍺⍺ ⍵⍵ ⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[244] 	type≡╠2 3 3╣:⍺ ⍺⍺ ⍵⍵ ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[245] 	type≡╠0 3 3╣:⍺⍺ ⍵⍵ ⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[245] 	type≡╠0 3 3╣:⍺⍺ ⍵⍵ ⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[245] 	type╠≡╣0 3 3:⍺⍺ ⍵⍵ ⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[245] 	type≡╠0 3 3╣:⍺⍺ ⍵⍵ ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[246] 	type≡╠0 2 3╣:⍺⍺ ⍵⍵ ⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[246] 	type≡╠0 2 3╣:⍺⍺ ⍵⍵ ⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[246] 	type╠≡╣0 2 3:⍺⍺ ⍵⍵ ⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[246] 	type≡╠0 2 3╣:⍺⍺ ⍵⍵ ⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[247] 	type≡╠0 3 2╣:⍵ ⍺⍺ ⍵⍵");
	
		arr->shape[0] = 3;
	
		CHK(fill_array(arr, dat), cleanup, L"[247] 	type≡╠0 3 2╣:⍵ ⍺⍺ ⍵⍵");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.eqv)
		CHK(6, cleanup, L"[247] 	type╠≡╣0 3 2:⍵ ⍺⍺ ⍵⍵");
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		TRC(guard_check(x), L"[247] 	type≡╠0 3 2╣:⍵ ⍺⍺ ⍵⍵");
	...
	
	{
		...
		CHK(mk_array(&arr, typ, STG_HOST, rnk), cleanup, L"[248] 	⎕SIGNAL ╠2╣");
	
		CHK(fill_array(arr, dat), cleanup, L"[248] 	⎕SIGNAL ╠2╣");
	
		*stkhd++ = arr;
	}
	
	if (!cdf_prim.q_signal)
		CHK(6, cleanup, L"[248] 	╠⎕SIGNAL╣ 2");
    ...
    struct cell_func *self)
{
	...
	*stkhd++ = retain_cell(loc->type);
	...
	
	{
		...
		if (!err) {
			CHK(2, cleanup, L"[247] 	type≡0 3 2:╠⍵ ⍺⍺ ⍵⍵╣");
